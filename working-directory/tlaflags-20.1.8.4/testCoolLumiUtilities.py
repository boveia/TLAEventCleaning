...
lblbReader = CoolDataReader('COOLONL_TRIGGER/CONDBR2', '/TRIGGER/LUMI/LBLB')
lblbReader.setIOVRangeFromRun(runNumber)
lblbReader.readData()

# dir(lblbReader.data)
# print lblbReader.data

# dir(lblbReader.data[0].payload())
# print lblbReader.data[0].payload()
...
fillParamsReader = CoolDataReader("COOLONL_TDAQ/CONDBR2", "/TDAQ/OLC/LHC/FILLPARAMS")
...
bunchGroupReader = CoolDataReader("COOLONL_TRIGGER/CONDBR2", "/TRIGGER/LVL1/BunchGroupContent")
bunchGroupReader.setIOVRangeFromRun(runNumber)
bunchGroupReader.readData()
...
bunchDescriptionReader = CoolDataReader("COOLONL_TRIGGER/CONDBR2", "/TRIGGER/LVL1/BunchGroupDescription")
bunchDescriptionReader.setIOVRangeFromRun(runNumber)
...
bunchDataUtilReader = CoolDataReader("COOLONL_TDAQ/CONDBR2", "/TDAQ/OLC/LHC/BUNCHDATA")
...
bunchLumisUtilReader = CoolDataReader("COOLONL_TDAQ/CONDBR2", "/TDAQ/OLC/BUNCHLUMIS")
...
#/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.1.8/AtlasTrigger/20.1.8/Trigger/TrigAnalysis/TrigBunchCrossingTool/scripts/StandaloneBunchgroupLookup.py
