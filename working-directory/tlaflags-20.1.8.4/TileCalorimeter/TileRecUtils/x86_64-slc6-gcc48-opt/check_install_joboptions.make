...
#
#   Generated Wed Dec 16 17:42:37 2015  by boveia
#
#====================================
...
#cmt_local_tagfile_check_install_joboptions = $(TileRecUtils_tag)_check_install_joboptions.make
...
#cmt_local_tagfile_check_install_joboptions = $(TileRecUtils_tag).make
...
#cmt_final_setup_check_install_joboptions = $(bin)TileRecUtils_check_install_joboptionssetup.make
...
#cmt_final_setup_check_install_joboptions = $(bin)TileRecUtilssetup.make
cmt_local_check_install_joboptions_makefile = $(bin)check_install_joboptions.make
...
$(check_install_joboptionsactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.1.8/AtlasCore/20.1.8/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share *.py ' -installdir=/afs/cern.ch/work/b/boveia/tlaflags-20.1.8.4/InstallArea/jobOptions/TileRecUtils -level=
