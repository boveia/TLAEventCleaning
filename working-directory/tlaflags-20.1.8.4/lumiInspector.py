...
class LumiInspector:
    ...
    def loadLumi(self, run):
        ...
        if self.oflReader == None:
            if self.online:
                self.oflReader = CoolDataReader('COOLONL_TRIGGER/CONDBR2', '/TRIGGER/LUMI/LBLESTONL')
            else:
                self.oflReader = CoolDataReader('COOLOFL_TRIGGER/CONDBR2', '/TRIGGER/OFLLUMI/LBLESTOFL')
    ...
    def loadBCIDCali(self, iov):
        ...
        if self.caliReader == None:
            self.caliReader = CoolDataReader('COOLONL_TDAQ/CONDBR2', '/TDAQ/OLC/CALIBRATIONS')
    ...
    #         self.pmtReader = CoolDataReader('COOLONL_TDAQ/CONDBR2', '/TDAQ/OLC/LUCIDCURRENTS')
