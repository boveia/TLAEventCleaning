...
def makeRegScript(dbnames,catalog,dataset):
    ...
    print "Found %i files with a total size of  %.2f MBytes" % (len(pfns),size/(1024*1024.0))
...
if __name__=='__main__':
    ...
    if len(sys.argv)<4:
        ...
        dbs=[]
        for d in sys.argv[3:]:
            dbs+=["sqlite://;schema="+d+";dbname=OFLP200"]
        ...
        if errs:
            ...
            print "Output files:"
            print scriptname,"To upload files used by default reconstruction"
